...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      opt_data = opt_data || {};
      ie_open('div', null, null, 'class', 'liferay-live');
      ie_open('div', null, null, 'class', 'topper');
      ie_open('h1');
    ...
    function $commentForm(opt_data, opt_ignored, opt_ijData) {
      ie_open('section', null, null, 'class', 'comment-form');
      ie_open('form', null, null, 'data-onsubmit', 'handleCommentSubmit_');
      ie_open('div', null, null, 'class', 'input-submit-group');
      ie_open('input', null, null, 'class', 'form-control', 'id', 'text', 'name', 'text', 'placeholder', 'Comment...', 'type', 'text');
      ie_close('input');
  ...
  var LiferayLive = function (_Component) {
    babelHelpers.inherits(LiferayLive, _Component);

    function LiferayLive() {
      babelHelpers.classCallCheck(this, LiferayLive);
      return babelHelpers.possibleConstructorReturn(this, (LiferayLive.__proto__ || Object.getPrototypeOf(LiferayLive)).apply(this, arguments));
    }
  ...
  this['metalNamed']['LiferayLive'] = this['metalNamed']['LiferayLive'] || {};
  this['metalNamed']['LiferayLive']['LiferayLive'] = LiferayLive;
  this['metalNamed']['LiferayLive']['templates'] = templates;
  this['metal']['LiferayLive'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	var Component = this['metal']['component'];
	var Soy = this['metal']['Soy'];
	var templates = this['metal']['LiferayLive'];


	var COLLECTION_COMMENTS = 'comments';

	var COLLECTION_TALKS = 'talks';
	...
	var LiferayLive = function (_Component) {
		...
		babelHelpers.createClass(LiferayLive, [{
			key: 'attached',
			value: function attached() {
				...
				var authUrl = origin.replace('//hosting.', '//').replace('//', '//auth.');

				var dataUrl = origin.replace('//hosting.', '//').replace('//', '//data.');
			...
			key: 'afterFetchTalks_',
			value: function afterFetchTalks_(talks) {
				this.talks = talks;
			}
		}, {
			...
			key: 'fetchTalks_',
			value: function fetchTalks_() {
				var auth = this.auth;
				var data = this.data;


				data.get(COLLECTION_TALKS).then(this.afterFetchTalks_.bind(this));
			}
		}, {
			key: 'handleCommentSubmit_',
			value: function handleCommentSubmit_(event) {
			...
			key: 'handleSignOutClick_',
			value: function handleSignOutClick_() {
			...
			key: 'handleSignedIn',
			value: function handleSignedIn(currentUser) {
			...
			value: function handleTalkClick_(event) {
			...
			value: function handleTalkSubmit_(event) {
				event.preventDefault();
			...
			key: 'watchTalks_',
			value: function watchTalks_() {
				var data = this.data;


				this.talkWatcher = data.watch('talks').on('changes', this.afterFetchTalks_.bind(this));
			}
		}]);
		return LiferayLive;
	}(Component);
	...
	this['metal']['LiferayLive'] = LiferayLive;
}).call(this);
}).call(this);
